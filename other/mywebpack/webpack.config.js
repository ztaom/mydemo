    ...
    */
    ...
    devServer: config.devServer ? {
      ...
      */
      ...
      /*
      config.devServer.proxy用来配置后端api的反向代理, ajax /api/auth/*的请求会被转发到
      http://api.example.dev/auth/*, /api/pay/*的请求会被转发到 http://api.example.dev/pay/*.
    ...
    /*
    开发环境下把提示js文件超过250k的warning提示关闭.
    */
    performance: {
