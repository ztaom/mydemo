...
<body>
    ...
    <iframe class="ap" id="ap" src="includes/bsa.php" scrolling="no" height="0"></iframe><!-- .ap -->

	<footer>

		<div class="globalwidth">
			<a href="http://92webgame.com" target="_blank">就爱网页游戏</a>
		</div>

	</footer>
<script type="text/javascript" src="http://92webgame.com/statics/js/jquery-1.7.2.min.js"></script>
<script src="js/general.js?ver=1.4.3"></script>
<script>
var _gaq = [['_setAccount', 'UA-35857860-1'], ['_trackPageview']];
</script>
</body>
</html>