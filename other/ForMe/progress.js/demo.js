        ...
        if (req.readyState == 4) 
        {
          if (req.status == 200)
          {
            setTimeout(function() {
              ...
              document.querySelector("img[data-img='" + imgName  + "']").src = 'images/' + imgName + '.jpg?v=' + window.replayLoadImages + imgName;
            }, 500);
          }
        }
      };
      req.open("GET", "images/" + imgName + ".jpg?v=" + window.replayLoadImages + imgName, true);
      req.send();
