...
## 约定
- src下的每个html是一个入口页面
- 与html页面同名的 js文件为当前页面的js入口文件（如demo.html对应demo.js）
...
+ https://h5.m.youku.com//ju/omgentrance.html
...
+ 首页: com.youku.HomePageEntry

+ 发现: com.youku.hotspot.activity.HotSpotActivity

+ vip: com.youku.vip.wrapper.VipHomeActivity
