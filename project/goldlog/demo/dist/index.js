...
var _logStr = '/yt/ykpoplayer.ykpoplayer.poplayer';
var _checkStr = 'H1509201138';
var actId = null;
...
var logpop = {
    ...
    goldlog: function goldlog(action, posId, param) {
        var _str = 'actId=' + actId + '&posId=' + posId;
...
var _logpop = __webpack_require__(4);

var _logpop2 = _interopRequireDefault(_logpop);
...
//设置全局的
_logpop2.default.setActId('logh5');

var params = {
    'canyu': 1
};

_logpop2.default.goldlog('EXP', 'exposure');
...
document.querySelector('.btn1').addEventListener('click', function () {
    _logpop2.default.goldlog('CLK', 'clickbtn1');
});

//业务参与率
document.querySelector('.btn2').addEventListener('click', function () {
    _logpop2.default.goldlog('CLK', 'clickbtn2', params);
});

/***/ })
/******/ ]);
//# sourceMappingURL=index.js.map?45b93c9b9d13c32764b5